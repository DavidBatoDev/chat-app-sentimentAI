...
const User = () => {
  ...
  const fetchUserInfo = async () => {
    try {
      const res = await axios.get(
        `https://chat-app-sentimentai.onrender.com/api/user/fetch-other-user/${userId}`,
        {
          headers: {
  ...
  const handleFetchChat = async (userId) => {
    try {
      ...
      const res = await axios.get(
        `https://chat-app-sentimentai.onrender.com/api/chat/fetchChat/${userId}`,
        {
          headers: {
      ...
      >
        ...
        <div className=" flex flex-col items-center w-full gap-5 md:px-2 lg:px-10 pb-40">
          <div
            ...
            } bg-slate-200 relative rounded-full mt-12 w-32 h-32`}
          >
            <img
          ...
          <div
            className={`
                    ${
                      darkMode && "dark-secondary"
                    } bg-slate-200 w-full rounded-xl h-46 flex justify-between items-center gap-3 p-3
                `}
          >
            <div>
