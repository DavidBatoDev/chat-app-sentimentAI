...
const EditProfile = () => {
  ...
  const handleSaveChanges = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://chat-app-sentimentai.onrender.com/api/user/updateUser/${user._id}`,
        formBody,
        {
          headers: {
  ...
  return (
    <div
      className={`${
        darkMode && "dark-theme"
      } flex flex-col h-full md:flex-[0.7] flex-1 bg-slate-100 px-4`}
    >
      <Backdrop
      ...
      <form
        ...
        } h-full mb-3 bg-white p-4 mt-5 rounded-xl flex justify-between shadow overflow-y-scroll custom-scrollbar`}
      >
        <div className="fixed">
        ...
        <div className=" flex flex-col items-center w-full gap-5 md:px-2 lg:px-10">
          <div
            ...
            } bg-slate-200 rounded-full mt-12 w-32 h-32`}
          >
            <input
              hidden
              type="file"
            ...
            />
            <img
              src={formBody?.profilePic || user?.profilePic}
              alt="profile-pic"
          ...
          <div
            className={`
                        ${
                          darkMode && "dark-secondary"
                        } bg-slate-200 w-full rounded-xl flex flex-col gap-3 p-3
                    `}
          >
            <div>
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  } text-xl font-semibold w-full p-2 rounded outline-none`}
                  type="text"
                  name="name"
          ...
          <div
            className={`
                        ${
                          darkMode && "dark-secondary"
                        } bg-slate-200 w-full rounded-xl flex p-3 flex-col gap-5
                    `}
          >
            <div className="flex flex-col gap-2">
              ...
              <textarea
                className={`${
                  darkMode ? "bg-slate-800" : "bg-slate-100 "
                } w-full h-24 p-2 rounded outline-none`}
                ...
                <div>
                  <button
                    ...
                    className={`text-lg bg-slate-200 ${
                      darkMode && "dark-secondary bg-slate-900"
                    } border border-black rounded-full px-3 py-2 w-full`}
                    onClick={openModal}
                  >
                    Add Social
                  </button>
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`${
                darkMode && "dark-secondary"
              } bg-slate-200 text-lg rounded-full px-10 py-2 w-full mb-3`}
            >
              Save Changes
            </button>
          </div>
      ...
      >
        <div
          className={`${
            darkMode ? "dark-primary" : "bg-slate-200"
          } p-5 rounded-lg max-w-md w-full`}
        >
          ...
          <div className="mb-4">
            ...
            <select
              ...
              className={`border ${
                darkMode ? "border-slate-300" : "border-slate-900"
              } w-full bg-transparent p-2 rounded-full outline-none`}
            >
          ...
          <div className="flex justify-end gap-4">
            {!isEditingASocial ? (
              <button
                className="text-lg dark-secondary rounded-full px-3 py-2"
              ...
              <button
                className="text-lg dark-secondary rounded-full px-3 py-2"
                onClick={() => handleEditSocial(selectedIndex)}
              >
                Edit
              </button>
            )}
