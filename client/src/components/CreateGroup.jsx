  ...
  const handleCreateGroup = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://chat-app-sentimentai.onrender.com/api/chat/createGroup",
        { groupName, usersToBeAdded },
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      if (res.data.success == false)
        return console.log(res.data.response.message);
  ...
  return (
    ...
    >
      <form
        ...
        className="flex flex-col gap-2 mt-2 h-full w-full"
      >
        <div
          className={`${
            darkMode && "dark-primary"
          } flex items-center w-full bg-white mt-3 rounded-xl py-2 shadow-sm`}
        >
        ...
        <div
          className={`${
            darkMode && "dark-primary"
          } bg-white flex-1 mb-3 rounded-xl p-3`}
        >
